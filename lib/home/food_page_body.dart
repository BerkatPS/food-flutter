                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  BigText(text: "Nutritious fruit meal in Indonesia", color: AppColors.mainBlackColor,),
                                  SizedBox(height: Dimensions.height10,),
                                  SmallText(text: "With Indonesia Characteristics", color: AppColors.mainBlackColor,),
                                  SizedBox(height: Dimensions.height10,),
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      IconAndText(icon: Icons.access_time_rounded, text: "37min", iconColor: AppColors.iconColor2)
                                    ],
                                  )
                                ],
                              ),
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              ...
              margin: EdgeInsets.only(left: Dimensions.width30, right: Dimensions.width30, bottom: Dimensions.height30), // Kurangi margin bottom sedikit
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.radius30),
                  color: Colors.white,
                  boxShadow: [
              ...
              child: Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    BigText(text: "Kontol Balado ", color: Colors.black54),
                    SizedBox(height: Dimensions.height10,),
                    Row(
                      children: [
                        Wrap(
                        ...
                        SizedBox(width: Dimensions.width10,),
                        SmallText(text: "1024 Comments", color: AppColors.mainBlackColor,)
                      ],
                    ),
